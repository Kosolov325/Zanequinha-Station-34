...
all information below is fake news this atmospherics system fucking sucks
...
area
	var/atmos_simulation_required = 1
turf
...
//				assemble_group_object(obj/movable/floor/base)
			...
			setup()
				...
				world << "\red \b Processing Geometry by area..."

				var/start_time = world.timeofday

				for(var/area/i in world)
					if(i.atmos_simulation_required)
						for(var/turf/simulated/S in i.contents)
