...
/obj/debuggerteleport
	...
	Bumped(var/mob/M)
		if(istype(M,/mob))
			M << "<font color='green'><b>Teleporting to debugging area."
			M.loc = locate(rand(99,118),rand(84,98),1) //99,84 to 118,19
			M.heightZ = 90
...
/obj/debuggerteleportBACC
	...
	Bumped(var/atom/movable/M)
		M << "<font color='green'><b>Teleporting to game area."
		M.loc = locate(rand(49,65),rand(57,69),1) //49,57 65,69
...
/obj/machinery/vending/snack
	name = "snack machine"
	desc = "Just a placeholder until we get food figured out."
	icon_state = "snack"
...
/obj/machinery/vending/redditor
	name = "redditor vending machine"
	desc = "Looks like some fucking idiot designed it."
	icon_state = "reddit"
