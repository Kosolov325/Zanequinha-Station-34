...
#define screen_loc_g "SOUTH+1:16"
/obj/item/weapon/proc/orient_objs(x1)
	var/CX = 0
...
/obj/item/weapon/proc/orient2hud(mob/user as mob)
...
/obj/item/weapon/secstorage/attack_self(mob/user as mob)
	...
	user << browse(cssStyleSheetDab13 + dat, "window=caselock;size=300x280")
...
/obj/item/weapon/proc/create_storage()

	var/obj/screen/storage/boxes = new /obj/screen/storage()
	boxes.name = "storage"
	boxes.master = src
