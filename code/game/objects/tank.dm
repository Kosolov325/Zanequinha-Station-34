...
/obj/item/weapon/tank/air/New()
	...
	src.air_contents.oxygen = (180*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C) * O2STANDARD
	src.air_contents.nitrogen = (180*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C) * N2STANDARD
	return
...
/obj/item/weapon/tank/jetpack/New()
	..()
	src.air_contents.oxygen = (180*ONE_ATMOSPHERE)*70/(R_IDEAL_GAS_EQUATION*T20C)
	return
