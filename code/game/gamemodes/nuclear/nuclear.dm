...
/datum/game_mode/nuclear/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	synd_mob.equip_if_possible(new /obj/item/clothing/under(synd_mob), synd_mob.slot_w_uniform)
