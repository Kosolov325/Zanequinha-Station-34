...
#define TANK_LEAK_PRESSURE		(480.*ONE_ATMOSPHERE)	// Tank starts leaking
#define TANK_RUPTURE_PRESSURE	(490.*ONE_ATMOSPHERE) // Tank spills all contents into atmosphere

#define TANK_FRAGMENT_PRESSURE	(500.*ONE_ATMOSPHERE) // Boom 3x3 base explosion
...
#define MASKCOVERSEYES 1024		// get rid of some of the other kryfrac level retardation in these flags
